...
# It joins the orgregistropropiedad peers to the channel previously setup in
...
infoln "Joining orgregistropropiedad peer to the channel..."
joinChannel 3

infoln "Setting anchor peer for orgregistropropiedad..."
setAnchorPeer 3

successln "Channel '$CHANNEL_NAME' joined"
successln "Orgregistropropiedad peer successfully added to network"
