...
# It joins the orgcontraloria peers to the channel previously setup in
...
infoln "Joining orgcontraloria peer to the channel..."
joinChannel 3

infoln "Setting anchor peer for orgcontraloria..."
setAnchorPeer 3

successln "Channel '$CHANNEL_NAME' joined"
successln "Orgcontraloria peer successfully added to network"
