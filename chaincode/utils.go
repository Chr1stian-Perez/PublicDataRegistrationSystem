...
const (
	...
	MSP_ACADEMIC_REGISTRY = "OrgregistroacademicoMSP" // Academic Registry
	MSP_PROPERTY_REGISTRY = "OrgregistropropiedadMSP" // Property Registry
	MSP_POLICE_REGISTRY   = "OrgregistropolicialMSP"  // Police Registry
)
